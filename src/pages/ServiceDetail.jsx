...
export default function ServiceDetail() {
  ...
  return (
    <div className="px-2 md:px-4 py-10">
      ...
      {/* Hero image */}
      {service.images?.[0] && (
        <div className="relative overflow-hidden rounded-2xl border border-neutral-200 dark:border-neutral-800 bg-white/70 dark:bg-neutral-900/50 backdrop-blur">
          <img
            src={service.images[0]}
            alt={`${service.title} visual`}
            loading="eager"
            className="h-[22rem] md:h-[28rem] w-full object-cover object-center"
          />
